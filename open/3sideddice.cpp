...
const T eps = 1e-8, INF = 10000000000000;
#define MP make_pair
...
signed main()
{
	...
	{
		if (mat[0][0] == 0 && mat[0][1] == 0 && mat[0][2] == 0) break;
		repp(i, 1, 3) rep(j, 3) cin >> mat[i][j];
		vd c = { mat[0][0] + mat[0][1] + mat[0][2], mat[1][0] + mat[1][1] + mat[1][2], mat[2][0] + mat[2][1] + mat[2][2] };
		vvd a = {
		...
		cin >> b[0] >> b[1] >> b[2];
		vd x;
		double res = LPSolver(a, b, c).solve(x)-b[0]-b[1]-b[2];
		if (abs(res) < epsilon)
		{
			cout << "YES\n";
		}
