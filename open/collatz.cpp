...
int32_t main()
{
    ...
    while (true)
    {
        ...
        if (a==b)
        {
            cout << origA << " needs " << 0 << " steps, " << origB << " needs " << 0 << " steps, they meet at " << origA << "\n";
            continue;
        }
        map<int, int> seenA;
        map<int, int> seenB;
        ...
        while (true)
        {
            if (!setcontains(seenA, a)) seenA[a] = i;
            if (!setcontains(seenB, b)) seenB[b] = i;
            if (a!=1)
            {
                if (a % 2 == 0) a /= 2;
                else a = 3 * a + 1;
            ...
            if (setcontains(seenA, b))
            {
                cout << origA << " needs " << seenA[b] << " steps, " << origB << " needs " << i << " steps, they meet at " << b << "\n";
                break;
            }
            if (setcontains(seenB,a))
            {
                cout << origA << " needs " << i << " steps, " << origB << " needs " << seenB[a] << " steps, they meet at " << a << "\n";
                break;
            }
            if (a == b)
            {
                cout << origA << " needs " << i << " steps, " << origB << " needs " << i << " steps, they meet at " << b << "\n";
                break;
            }
        }
