...
int32_t main()
{
    ...
    if (dotpos>0)
    {
        ...
        string ending(n.begin() + dotpos, n.end());
        while (ending.size()&&ending.back() == '0') ending.pop_back();
        if (ending.size())
        {
            cout << "." << ending;
        }
    ...
    {
        cout << "0.";
        rep(i, 0 - dotpos) cout << "0";
        string ending(n.begin(), n.end());
        while (ending.size() && ending.back() == '0') ending.pop_back();
        cout << ending;
    }
