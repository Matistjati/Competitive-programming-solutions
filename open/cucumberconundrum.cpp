...
int32_t main()
{
    ...
    vector<double> minradius = { 0,1,2,1 + 2. / 3 * sqrt(3),1 + sqrt(2),1 + sqrt(2 * (1 + 1. / sqrt(5))), 3,3 };

    double sandwhichArea = s * s * 3.1415926535897932384;
    repp(i, 1, n + 1)
    {
        double area = i * (r * r * 3.1415926535897932384);
        if (area / sandwhichArea * 100 > z) break;
