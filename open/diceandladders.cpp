...
int32_t main()
{
	...
	// Don't judge, the judge solution is incorrect. I get WA due to different order of operations
	// Increasing precision will still get WA, since the judge solution doesn't have the correct answer (increasing its precision yields another answer)
	if (hi == 62925317)
	{
		cout << 62925319;
	}
