...
bool whowins(int n)
{
    ...
    per(i, n)
    {
        ...
        while (setcontains(states, mex)) mex++;
        v[i] = mex;
        if (states.size() == 0) v[i] = -1;
    }
...
int32_t main()
{
    ...
    while (cin >> n)
    {
        cout << (whowinsfast(n) ? "Stan" : "Ollie") << " wins.\n";
    }

    //repp(i, 2, 1000000)
    //{
    //    if (whowins(i)!=whowinsfast(i))
    //    {
    //        cout << i << ": asdasd\n";
    //    }
    //    if (whowins(i)==1&&whowins(i-1)==0)
    //    {
    //        cout << "start: " << i << "\n";
    //    }
    //    if (whowins(i)==0&&whowins(i-1)==1)
    //    {
    //        cout << "stop: " << i << "\n";
    //    }
    //    //cout << i << ": " << (whowins(i)==0) << "\n";
