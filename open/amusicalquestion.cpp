...
int32_t main()
{
    ...
    rep(i, c + 1)
    {
        rep(j, c + 1)
        {
            ...
            {
                p2 k = p2(i, j);
                if (k.first + k.second > best.first + best.second)
                {
                    best = k;
                }
                else if (k.first + k.second == best.first + best.second && abs(k.first - k.second) < abs(best.first - best.second))
                {
                    best = k;
                }
            }
