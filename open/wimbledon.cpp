...
int32_t main()
{
	...
	rep(i, n)
	{
		read(countries[i].first);
		totplayers += countries[i].first;
		read(countries[i].second);
	}
	...
	t = 0;
	int suffixvalue = 0;
	repp(i, 1, n) suffixvalue += countries[i].first;
	int prefixmultiplier = 0;
	rep(i, n - 1)
	{
		midfix[i] = t;
		suffixvalue -= countries[i + 1].first;
		t += suffixvalue * countries[i].first;
		t -= prefixmultiplier * countries[i + 1].first;
		prefixmultiplier += countries[i].first;
	}
