...
int best2(int normal, int strong, int moves, int best, vvvi& dp)
{
    if (moves + 1 > best)
    {
        return 0;
    }
    int& v = dp[normal][strong][moves];
...
int32_t main()
{
    ...
    while (t--)
    {
        ...
        opt++;
        vvvi dp2(a+opt+2, vvi(b+2, vi(opt + 1, -1)));
        cout << best2(a, b, 0, opt, dp2) << "\n";
