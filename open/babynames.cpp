...
int32_t main()
{
    ...
    indexed_set<string> male;
    indexed_set<string> female;
    while (true)
    {
        dread(int, t);
        ...
        else if (t == 1)
        {
            dread(string, name);
            dread(int, gender);
            if (gender == 2) female.insert(name);
            else male.insert(name);
        }
        else if (t == 2)
        {
            dread(string, name);
            if (setcontains(male, name)) male.erase(name);
        ...
        else if (t == 3)
        {
            ...
            dread(int, q);
            int s = 0;
            if (q == 0 || q == 1) s += male.order_of_key(b) - male.order_of_key(a);
            if (q == 0 || q == 2) s += female.order_of_key(b) - female.order_of_key(a);
            cout << s << "\n";
        }
    }
