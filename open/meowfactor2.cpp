...
int32_t main()
{
    ...
    // Answer of 4 always possible. can we do better?

    rep(i, sz(s) - 3) // answer 0
    {
        if (s[i] == 'm' && s[i + 1] == 'e' && s[i + 2] == 'o' && s[i + 3] == 'w')
        {
            ans(0);
        }
    }

    rep(i, sz(s) - 2) // answer 1
    {
        if (s[i] == 'm' && s[i + 1] == 'e' && s[i + 2] == 'o')
        {
            ans(1);
        }
        ...
        if (s[i] == 'e' && s[i + 1] == 'o' && s[i + 2] == 'w')
        {
            ans(1);
        }
    }

    rep(i, sz(s) - 3) // answer 1
    {
        if (s[i] == 'm' && s[i + 2] == 'o' && s[i + 3] == 'w')
        {
            ans(1);
        }

        if (s[i] == 'm' && s[i + 1] == 'e' && s[i + 3] == 'w')
        {
            ans(1);
        }

        if (s[i] == 'e' && s[i + 1] == 'm' && s[i + 2] == 'o' && s[i + 3] == 'w')
        {
            ans(1);
        }

        if (s[i] == 'm' && s[i + 1] == 'o' && s[i + 2] == 'e' && s[i + 3] == 'w')
        {
            ans(1);
        }

        if (s[i] == 'm' && s[i + 1] == 'e' && s[i + 2] == 'w' && s[i + 3] == 'o')
        {
            ans(1);
        }
    }
    ...
    rep(i, sz(s) - 4) // answer 1
    {
        if (s[i] == 'm' && s[i + 1] == 'e' && s[i + 3] == 'o' && s[i + 4] == 'w')
        {
            ans(1);
        }
    }

    rep(i, sz(s) - 1) // answer 2
    {
        if (s[i] == 'm' && s[i + 1] == 'e')
        {
            ans(2);
    ...
    rep(i, sz(s) - 2)
    {
        ...
        if (s[i] == 'e' && s[i + 1] == 'm' && s[i + 2] == 'o')
        {
            ans(2);
        }

        if (s[i] == 'm' && s[i + 1] == 'o' && s[i + 2] == 'e')
        {
            ans(2);
        }
    }
