...
void TypeLetter(char l)
{
    ...
    chars[currnode] = l;
    if (currnode == 0) upTree[currnode][0] = 0;
    else upTree[currnode][0] = location;
    ...
    repp(d, 1, lgmaxn)
        upTree[currnode][d] = upTree[upTree[currnode][d - 1]][d - 1];
