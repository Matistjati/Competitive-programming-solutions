...
// Completely overkill, but I've already written this code before
// Solves tree matching where each node can be matched to at most k others while minimizing sum of edge costs
int n, k;
